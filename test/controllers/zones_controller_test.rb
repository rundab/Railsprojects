...
class ZonesControllerTest < ActionController::TestCase
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post :create, zone: { event_id: @zone.event_id, hour_limit: @zone.hour_limit, meter_pct: @zone.meter_pct, name: @zone.name, sqft: @zone.sqft }
    end
  ...
  test "should update zone" do
    patch :update, id: @zone, zone: { event_id: @zone.event_id, hour_limit: @zone.hour_limit, meter_pct: @zone.meter_pct, name: @zone.name, sqft: @zone.sqft }
    assert_redirected_to zone_path(assigns(:zone))
  end
